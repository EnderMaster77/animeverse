...
@export var hit_lag_duration: float = 0.1 ## Amount of time the player is stunned during the attack.

#@export var speed_multiplier:Vector2 = Vector2(1.0,1.0) ## Multiplies your speed by this number during the attack. Set number to a decimal to make the character go slower.
...
func _ready():
	...
	$hitlag.wait_time = hit_lag_duration
